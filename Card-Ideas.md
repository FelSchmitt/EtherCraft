...
- Ability: **Scorched Trail** — When this card destroys an enemy minion in combat, that minion's card is permanently removed from the opponent's deck for the rest of the match (burned to ash, cannot be redrawn).
