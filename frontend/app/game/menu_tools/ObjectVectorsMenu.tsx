export function ObjectVectorsMenu() {
    return (
        <div id='object-positions-display' className='absolute w-[18vw] min-h-[15vh] border-2 border-zinc-700 bg-[#aaa] flex justify-evenly flex-col p-1 items-center'>
            ...
            <button id="get-object-vectors" className='text-sm border-black border-2 rounded-[5px] mt-6 bg-amber-400 cursor-pointer font-bold'>Get Values of Selected Object</button>
        </div>
    )
}